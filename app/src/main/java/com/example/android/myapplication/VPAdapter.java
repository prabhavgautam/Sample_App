...
public class VPAdapter extends RecyclerView.Adapter<VPAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.viewpager_item_ivImage);
            tvHeading = itemView.findViewById(R.id.viewpager_item_tvHeading);
            tvDesc = itemView.findViewById(R.id.viewpager_item_tvDesc);
        }
    }
